...
load_dotenv()
google_api_key = os.getenv("GOOGLE_API_KEY")    #Seleecionamos la apikey del modelo
...
def init_components():
    ...
    client = QdrantClient(url=os.getenv("qdrant_url"), api_key=os.getenv("qdrant_api_key")) #Nos conectamos a nuestro qdrant (el client es el de la cuenta)
    return QdrantVectorStore(client=client, collection_name="Prueba_RAG",
